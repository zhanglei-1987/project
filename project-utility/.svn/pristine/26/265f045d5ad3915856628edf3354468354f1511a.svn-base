...
public class Snowflake {
	...
	private static final Map<String, Snowflake> caches = new ConcurrentHashMap<>();
	...
	public static long next(long datacenterId, long workerId) {

		String key = Strings.concat(datacenterId, ":", workerId);

		Snowflake snowflake = caches.get(key);

		if (snowflake == null) {

			snowflake = new Snowflake(datacenterId, workerId);

			caches.put(key, snowflake);
